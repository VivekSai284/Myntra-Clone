...
export default function Wishlist() {
  ...
  const fetchproduct = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        `https://myntra-clone-j4a9.onrender.com/wishlist/${user._id}`,
      );
  ...
  const handledelete = async (itemid: any) => {
    try {
      await axios.delete(
        `https://myntra-clone-j4a9.onrender.com/wishlist/${itemid}`,
      );
      fetchproduct();
    } catch (error) {
      console.log(error);
      ...
      <View style={styles.container}>
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyTitle}>
            Your wishlist is lonely. Login to see your picks!
          </Text>
          <TouchableOpacity
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        {isLoading ? (
          ...
          wishlist
            ?.filter((item: any) => item?.productId) // 👈 remove broken data
            .map((item: any) => (
