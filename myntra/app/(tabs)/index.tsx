...
export default function Home() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Image source={{ uri: "https://images.unsplash.com/photo-1445205170230-053b83016050?w=800&auto=format&fit=crop" }} style={styles.banner} />
...
const createStyles = (theme: any) => StyleSheet.create({
  ...
  header: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: 15, paddingTop: 50, backgroundColor: theme.colors.background, borderBottomWidth: 1, borderBottomColor: theme.colors.border },
  logo: { fontSize: 24, fontWeight: "bold", color: theme.colors.text, letterSpacing: 2 },
  searchButton: { padding: 8 },
  banner: { width: "100%", height: 220, resizeMode: "cover" },
  section: { padding: 15 },
  sectionHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 15 },
  sectionTitle: { fontSize: 16, fontWeight: "bold", color: theme.colors.text, letterSpacing: 1 },
  viewAll: { flexDirection: "row", alignItems: "center" },
  viewAllText: { color: theme.colors.primary, marginRight: 5, fontWeight: "600" },
  categoriesScroll: { marginHorizontal: -15, paddingLeft: 15 },
  categoryCard: { width: 85, marginRight: 15, alignItems: 'center' },
  categoryImage: { width: 70, height: 70, borderRadius: 35, backgroundColor: theme.colors.card },
  categoryName: { textAlign: "center", marginTop: 8, fontSize: 12, color: theme.colors.text, fontWeight: '500' },
  productsGrid: { flexDirection: "row", flexWrap: "wrap", justifyContent: 'space-between' },
  productCard: { width: "48%", marginBottom: 15, backgroundColor: theme.colors.card, borderRadius: 10, overflow: 'hidden', borderWidth: 1, borderColor: theme.colors.border },
  productImage: { width: "100%", height: 200 },
  productInfo: { padding: 10 },
  brandName: { fontSize: 13, color: theme.colors.subText, fontWeight: "bold" },
  productName: { fontSize: 14, color: theme.colors.text, marginVertical: 2 },
  priceRow: { flexDirection: "row", alignItems: "center", marginTop: 4 },
  productPrice: { fontSize: 14, fontWeight: "bold", color: theme.colors.text, marginRight: 6 },
